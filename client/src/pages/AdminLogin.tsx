...
export default function AdminLogin() {
  ...
  // Redirect authenticated admins to dashboard using useEffect
  useEffect(() => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full" preserveAspectRatio="none">
            <defs>
              <pattern id="adminDots" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
        ...
        <div className="relative z-10 w-full max-w-md px-6">
          <div className="bg-black border-2 border-yellow-400 rounded-2xl p-8 md:p-12 shadow-2xl text-center">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="bg-black border-2 border-yellow-400 rounded-2xl p-8 md:p-12 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Sahu Travels Management</p>
          </div>
